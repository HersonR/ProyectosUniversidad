...
namespace ExamenFinal01
{
    public class CursoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodigoCurso,CodigoCatedratico,NombresCurso,NotaCurso,EstadoNota")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodigoCurso,CodigoCatedratico,NombresCurso,NotaCurso,EstadoNota")] Curso curso)
        {
